#include <stdio.h>
/*getchar() reads the next input character from an input stream and returns that as its value
putchar() prints a character each time it is called. For example,
